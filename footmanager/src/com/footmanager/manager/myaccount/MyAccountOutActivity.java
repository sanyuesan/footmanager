...
public class MyAccountOutActivity extends Activity {
	//标题栏布局
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_account_out_activity);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.my_account_out, menu);
		return true;
	}
