package com.footmanager.util.dateutil;
...
public class KCalendar extends ViewFlipper implements
	 ...
	 * @param i
	 * @param j
	 * @param type false不是本月数据,不置标记;true是本月数据,设置标记
	 */
	private void setMarker(RelativeLayout group, int i, int j,boolean flag) {
		if(flag){
			...
			if (marksMap.get(dates[i][j]) != null) {
				if (childCount < 2) {
					...
					markView.setBackgroundResource(R.drawable.calendar_attendance_yes);
					group.addView(markView);
					
					RelativeLayout.LayoutParams typeLayout = new RelativeLayout.LayoutParams(
							(int) (tb * 1.7), (int) (tb * 1.7));
					typeLayout.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
					typeLayout.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
					typeLayout.setMargins(0, 0, 1, 1);
					TextView textView = new TextView(getContext());
					//textView.setBackgroundResource(marksMap.get(dates[i][j]));
					textView.setLayoutParams(typeLayout);
					textView.setText("早");
					//textView.setBackgroundResource(R.drawable.attendance_yes);
					group.addView(textView);
					
					RelativeLayout.LayoutParams typeLayout1 = new RelativeLayout.LayoutParams(
							(int) (tb * 1.7), (int) (tb * 1.7));
					typeLayout1.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
					typeLayout1.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
					typeLayout1.setMargins(0, 0, 1, 1);
					TextView textView1 = new TextView(getContext());
					//textView.setBackgroundResource(marksMap.get(dates[i][j]));
					textView1.setLayoutParams(typeLayout1);
					textView1.setText("值");
					//textView.setBackgroundResource(R.drawable.attendance_yes);
